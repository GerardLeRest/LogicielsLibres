                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <td><a href="https://fr.wikipedia.org/wiki/GNU_Affero_General_Public_License">Licence publique générale Affero</a></td>
                            </tr>
                        </tbody>
                    </table>  
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="assets/images/pdfsambasic/pdfsambasic1.png" class="img-fluid d-block w-100" alt="image1 de Pdfsam Basic">
                            </div>
                            <div class="carousel-item">
                                <img src="assets/images/pdfsambasic/pdfsambasic2.png" class="img-fluid d-block w-100" alt="image2 de Pdfsam Basic">
                            </div>
                        </div>
