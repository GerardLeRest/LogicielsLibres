...
$liensURL = ['href="accueil"', 'hreF="joplin"', 'href="keeppassxc"', 'href="pdfsambasic"'];
   
$titres = ["Introduction", "Joplin", "Keeppassxc", "PdfSamBasic"];

$titrePrincipaux = ["Introduction", "Joplin", "Keeppassxc", "PdfSamBasic"];
